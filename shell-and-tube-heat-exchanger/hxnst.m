...
if ptype > 0
    ...
    else; Nvar = 3;  % calculate tube-side flow rate(Wi)
    end    
end
...
Hs = htcshell(Do,Ds,L-2e-3*Ls,Lbc,Lbin,Lbout,Lc,Dotl,Dsb,Pt,...
...
fprintf('Shell-side: Ts1 = %g(K), Ts2 = %g(K), flow rate =%g(kg/s)\n',Ts1,Ts2,Ws);